...
type LicenseKeyData = Data<
  Attributes,
  Pick<Relationships, 'store' | 'customer' | 'order' | 'order-item' | 'product' | 'license-key-instances'>
>

export type GetLicenseKeyParams = Pick<Params<(keyof LicenseKeyData['relationships'])[]>, 'include'>
...
export type LicenseKey = Omit<LemonSqueezyResponse<LicenseKeyData, unknown, Pick<Links, 'self'>>, 'meta'>
export type ListLicenseKeys = LemonSqueezyResponse<LicenseKeyData[], Pick<Meta, 'page'>, Pick<Links, 'first' | 'last'>>
