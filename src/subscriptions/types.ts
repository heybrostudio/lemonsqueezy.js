...
export type GetSubscriptionParams = Pick<Params<(keyof SubscriptionData['relationships'])[]>, 'include'>
...
export type Subscription = Omit<LemonSqueezyResponse<SubscriptionData, unknown, Pick<Links, 'self'>>, 'meta'>
