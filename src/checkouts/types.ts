...
type CheckoutResponseData = Data<Attributes, Pick<Relationships, 'store' | 'variant'>>
...
export type GetCheckoutParams = Pick<Params<(keyof CheckoutResponseData['relationships'])[]>, 'include'>
export type ListCheckoutsParams = Params<
  GetCheckoutParams['include'],
  { storeId?: number | string; variantId?: string | number }
>
export type Checkout = Omit<LemonSqueezyResponse<CheckoutResponseData, unknown, Pick<Links, 'self'>>, 'meta'>
export type ListCheckouts = LemonSqueezyResponse<CheckoutResponseData[], Pick<Meta, 'page'>, Omit<Links, 'self'>>
